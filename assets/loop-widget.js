...
function updatePriceInUILoop({ productId }) {
    ...
    let subscriptionCompareAtPrice = document.querySelectorAll('.loop-subscription-group-price-amount-original');
    subscriptionCompareAtPrice.forEach(el => {
      el.innerHTML = loopFormatMoney(variant.price, true);
    });
